...
Rip* Rip::LoadZip(const CHAR* filename, const CHAR* configFile)
{
    unzFile file;
    ...
    do {
        unz_file_info info;
        if (unzGetCurrentFileInfo(file, &info, name, 256, NULL, NULL, NULL, NULL) != UNZ_OK)
            continue;
